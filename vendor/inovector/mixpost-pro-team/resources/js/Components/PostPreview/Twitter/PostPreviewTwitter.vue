...
import URLPreview from "../Twitter/URLPreview.vue";
        ...
        <template v-for="(contentItem, index) in props.content">
            <div :class="{'thread pb-md': index !== props.content.length - 1}" class="relative flex items-start">
                ...
                <div class="w-full">
                    ...
                    <div v-tooltip="$t('service.representative_data')" class="mt-5 flex items-center justify-between">
                        <div class="flex items-center">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-xs">312</div>
                        </div>
                        <div>
                            <svg class="w-5 h-5" viewBox="0 0 24 24" data-testid="iconOutgoing" aria-hidden="true">
                                <g>
                                    <path
