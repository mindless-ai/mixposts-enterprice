...
<template>
    <Panel>
        ...
        <template #description>
            ...
            <ReadDocHelp :href="`${$page.props.mixpost.docs_link}/services/social/linked-in/`"
                         class="mt-xs"/>
        </template>
        ...
        <HorizontalGroup class="mt-lg">
            ...
            <Select v-model="form.configuration.product"
                    :error="errors['configuration.product'] !== undefined"
                    id="product">
            ...
            <template #footer>
                <Error :message="errors['configuration.product']"/>
            </template>
        </HorizontalGroup>
