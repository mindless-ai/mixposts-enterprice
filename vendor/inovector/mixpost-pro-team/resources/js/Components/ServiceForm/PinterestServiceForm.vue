...
<template>
    <Panel class="mt-lg">
        ...
        <template #description>
            ...
            <ReadDocHelp :href="`${$page.props.mixpost.docs_link}/services/social/pinterest`"
                         class="mt-xs"/>
        </template>

        <HorizontalGroup class="mt-lg">
            <template #title>
                <label for="id">App ID <LabelSuffix danger>*</LabelSuffix></label>
            </template>
        ...
        <HorizontalGroup class="mt-lg">
            <template #title>
                <label for="secret">App secret key <LabelSuffix danger>*</LabelSuffix></label>
            </template>
        ...
        <HorizontalGroup class="mt-lg">
            ...
            <Select v-model="form.configuration.environment"
                    :error="errors['configuration.environment'] !== undefined"
                    id="env">
            ...
            <template #footer>
                <Error :message="errors['configuration.environment']"/>
            </template>
        </HorizontalGroup>
