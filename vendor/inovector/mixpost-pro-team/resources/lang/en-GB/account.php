  ...
  [
    ...
    [
      ...
      [
        ...
        'line1' => 'It\'s looks like we\'ve lost connection to your :name (:provider) account.',
        'line2' => 'While the connection is lost, we cannot publish posts or provide analytics for this account. Please, reconnect your account as soon as possible!',
        'line3' => 'To reconnect your account, click the button below and then click the "Add account" button.',
      ],
    ],
  ],
