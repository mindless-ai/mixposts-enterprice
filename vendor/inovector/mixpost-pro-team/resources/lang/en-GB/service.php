...
return [
  ...
  [
    ...
    'disclose' => 'Content Disclosure Setting',
    ...
    'disclose_desc' => 'Turn on to disclose that this video promotes goods or services in exchange for something of value. Your video could promote yourself, a third party, or both.',
    'promo_video_alert' => 'Your video will be labeled "Promotional content". ',
    'branded_content_desc' => 'You are promoting another brand or a third party. This video will be classified as Branded Content.',
    'your_brand_desc' => 'You are promoting yourself or your own business. This video will be classified as Brand Organic.',
    'your_brand_accept_terms' => 'By posting, you agree to TikTok\'s <a href=":href" target="_blank" class="link">Music Usage Confirmation</a>.',
    'accept_terms' => 'By posting, you agree to TikTok\'s <a href=":href_brand" target="_blank" class="link">Branded Content Policy</a> and <a href=":href_music" target="_blank" class="link">Music Usage Confirmation</a>.',
    'partner_video_alert' => 'Your video will be labeled "Paid partnership". ',
    'visibility_branded_content' => 'Visibility for branded content can\'t be private. Select "Everyone/Friends" visibility to enable this option.',
    'allow_users' => 'Allow users to',
    'comment' => 'Comment',
    'duet' => 'Duet',
    'stitch' => 'Stitch',
    'branded_no_private' => 'Branded content visibility cannot be set to private.',
    'content_disclosure_required' => 'You need to indicate if your content promotes yourself, a third party, or both.',
    'privacy_level_required' => 'It looks like you haven\'t chosen who can watch your video.',
  ],
  'pinterest' => 
  [
  ...
  'threads' => 
  [
    'connect' => 'Connect a new Threads profile',
  ],
  'bluesky' => 
  [
    'connect_profile' => 'Connect a new Bluesky profile',
    'service' => 'Service',
