...
class WebhooksController extends Controller
{
    ...
    {
        return Inertia::render('Admin/Webhooks/CreateEdit', [
            'mode' => 'create',
            'record' => null,
            'events' => MixpostWebhook::getSystemEventSelectionOptions(),
        ]);
    }
    ...
    public function store(StoreWebhook $storeWebhook): RedirectResponse
    {
        ...
        return redirect()
            ->route('mixpost.system.webhooks.edit', ['webhook' => $record->uuid])
    ...
    public function destroy(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('mixpost.system.webhooks.index')
