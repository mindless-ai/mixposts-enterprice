...
{
    protected function publishFacebookStandardPost(string $text, Collection $media, $params): SocialProviderResponse
    {
    ...
    protected function publishFacebookStandardPostDefault(string $text, Collection $media, $url = ''): SocialProviderResponse
    {
